...
--where DiedDuringThisEvent = 1
	...
	select count(*)
FROM mohprep..firstadmissions18plusfrom2006CombinedV3
1613409
...
select  *
into mohprep..firstadmissions18plusfrom2006MortalityV3
FROM [MoHPrep].[dbo].[firstadmissions18plusfrom2006CombinedV3]
where diedduringthisevent = 1
--9874
(9832 rows affected)

select  *
into mohprep..firstadmissions18plusfrom2006NonMortalityV3
FROM [MoHPrep].[dbo].[firstadmissions18plusfrom2006CombinedV3]
...
select * 
into mohprep..firstadmission18plusfrom2006SubsetV3
from (
select * from mohprep..firstadmissions18plusfrom2006NonMortalityV3 h
where randomnumber <  30000.0/1613959.0 --25000/1649161.0
union 
select * from mohprep..firstadmissions18plusfrom2006MortalityV3  h --9874
) a 
...
--      ,[IPVisits9m]
  ...
  , Dep_score
  into mohprep..firstadmission18plusfrom2006SubsetDistilledV3
