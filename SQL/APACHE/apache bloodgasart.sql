--CREATE VIEW gen_bloodgas_ts AS
;
with pvt as
( 
...
--        from labevents le
into mimicprep..gen_bloodgas_ts_pvt
    from icustays ie
    left join labevents le
      on le.subject_id = ie.subject_id and le.hadm_id = ie.hadm_id
      and le.charttime >= (dateadd(hour, -6,ie.intime)) -- - interval '6' hour)
      and le.ITEMID in
--        where le.ITEMID in
      -- blood gases
      (
...
into mimicprep..gen_bloodgas_ts_bloodgasts
from mimicprep..gen_bloodgas_ts_pvt pvt
...
(
 ...
 into mimicprep..gen_bloodgas_ts_stg_spo2
  from CHARTEVENTS
  -- o2 sat
  where ITEMID in
  (
...
into  mimicprep..gen_bloodgas_ts_stg_fio2
  from CHARTEVENTS
  where ITEMID in
  (
    3420 -- FiO2
...
select bg.*
  ...
  , s1.spo2
into  mimicprep..gen_bloodgas_ts_stg2
from mimicprep..gen_bloodgas_ts_bloodgasts bg
left join mimicprep..gen_bloodgas_ts_stg_spo2 s1
  -- same patient
  on  bg.icustay_id = s1.icustay_id
  -- spo2 occurred at most 2 hours before this blood gas
  and s1.charttime between dateadd(hour, -2, bg.charttime)  and bg.charttime --- interval '2' hour
...
into mimicprep..gen_bloodgas_ts_stg3
from mimicprep..gen_bloodgas_ts_stg2 bg
left join mimicprep..gen_bloodgas_ts_stg_fio2 s2
  -- same patient
  on  bg.icustay_id = s2.icustay_id
  -- fio2 occurred at most 4 hours before this blood gas
  and s2.charttime between dateadd(hour, -4, bg.charttime) and bg.charttime -- - interval '4' hour
...
-- (
    SELECT
      ...
      O2Flow,
      REQUIREDO2
into mimicprep..gen_bloodgas_ts
    FROM mimicprep..gen_bloodgas_ts_stg3
...
select bloodgasart.hadm_id, bloodgasart.charttime, avg(bloodgasart.PO2) as PO2, avg(bloodgasart.FIO2gen) as FIO2, avg(bloodgasart.PaO2FiO2) / 100.0 as PaO2FiO2 
into mimicprep..bloodgasart
from mimicprep..gen_bloodgas_ts bloodgasart
group by bloodgasart.hadm_id, bloodgasart.charttime
order by bloodgasart.hadm_id, bloodgasart.charttime;
