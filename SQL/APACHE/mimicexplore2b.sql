...
, icu.LOS LOS_ICU_days
      ...
      ,[INTIME]
      ,[OUTTIME]
, datediff(day, icu.[INTIME],  pat.DOD) mortalityDays_icu
, datediff(month, icu.[INTIME],  pat.DOD) mortalityMonths_icu
, datediff(HOUR, icu.[INTIME],  pat.DOD) mortalityHours_icu
...
--or
 ...
 and [DEATHTIME] IS NOT NULL --4869
 --4901
