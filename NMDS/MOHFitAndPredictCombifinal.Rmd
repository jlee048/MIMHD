...
fitMICEmids <- with(midsMICEtrainPrepped,  glm(formula = InHospitalMortality ~ 1 + Age + IsMale + ethnicity3Groups+ surg01Spec + surg02Spec+ surg03Spec + ASA + Acuity + HasCancer + IsSmoker + WasSmoker, family = binomial("logit"), maxit=100), print=F)
...
# print('Fraction of Missing Information vs proportion of missing info')
# #cbind(estimate=impfitmeanestimates, std.error=sqrt(impfitTotalVariancePred), fmi, micefmi, propOfMissingInfo)
# cbind(MICEmidsfmi, MICEfmi, MRfmi, MIDASfmi, MIDASVAEfmi, propOfMissingInfo)
